...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'aqua_webcheckup', 'user' => 'studioaqua', 'password' => 'SAp4ssw0rd', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Aqua/WebCheckupBundle/Entity'))), 'Aqua\\WebCheckupBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('AquaWebCheckupBundle' => 'Aqua\\WebCheckupBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_58d064393962002daf6b4757dad4ec421f14e52d853fd4a6866ec95f7a43b493');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Aqua/WebCheckupBundle/Resources/views'), 'AquaWebCheckup');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('acc3a48338ad78edf47fdd8e19c371810');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AquaWebCheckupBundle' => 'Aqua\\WebCheckupBundle\\AquaWebCheckupBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'aqua_webcheckup',
            'database_user' => 'studioaqua',
            'database_password' => 'SAp4ssw0rd',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => 'acc3a48338ad78edf47fdd8e19c371810',
            'database_path' => NULL,
            ...
            'kernel.secret' => 'acc3a48338ad78edf47fdd8e19c371810',
            ...
            'assetic.ruby.bin' => '/Users/robertoperuzzo/.rvm/rubies/ruby-2.0.0-p643/bin/ruby',
            'assetic.sass.bin' => '/Users/robertoperuzzo/.rvm/gems/ruby-2.0.0-p643/bin/sass',
